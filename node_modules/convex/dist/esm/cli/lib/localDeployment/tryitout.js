...
export async function handleTryItOutDeployment(ctx, options) {
  if (await isOffline()) {
...
export async function loadTryItOutDeployment(ctx, deploymentName) {
...
export async function listExistingTryItOutDeployments(ctx) {
