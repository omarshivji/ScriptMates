...
export const dev = new Command("dev").summary("Develop against a dev deployment, watching for changes").description(
...
).addOption(new Option("--trace-events").default(false).hideHelp()).addOption(new Option("--debug-bundle-path <path>").hideHelp()).addOption(new Option("--live-component-sources").hideHelp()).addOption(
  new Option(
    "--configure [choice]",
  ...
  const selectionWithinProject = await deploymentSelectionWithinProjectFromOptions(ctx, cmdOptions);
