...
export declare function getDeploymentTypeFromConfiguredDeployment(raw: string): "prod" | "local" | "dev" | "preview" | null;
export declare function isTryItOutDeployment(deploymentName: string): boolean;
