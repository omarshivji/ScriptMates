...
export declare function performLogin(ctx: Context, { overrideAuthUrl, overrideAuthClient, overrideAuthUsername, overrideAuthPassword, overrideAccessToken, authFlow, open, acceptOptIns, dumpAccessToken, deviceName: deviceNameOverride, }?: {
