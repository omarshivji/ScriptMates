...
import { DeploymentName, DeploymentSelectionWithinProject } from "./lib/api.js";
 ...
 */
export declare function deploymentCredentialsOrConfigure(ctx: Context, deploymentSelection: DeploymentSelection, chosenConfiguration: ChosenConfiguration, cmdOptions: ConfigureCmdOptions, partitionId?: number | undefined): Promise<DeploymentCredentials & {
    deploymentFields: {
...
export declare function _deploymentCredentialsOrConfigure(ctx: Context, deploymentSelection: DeploymentSelection, chosenConfiguration: ChosenConfiguration, cmdOptions: ConfigureCmdOptions, partitionId?: number | undefined): Promise<DeploymentCredentials & {
    deploymentFields: {
        deploymentName: DeploymentName;
        deploymentType: string;
        projectSlug: string | null;
